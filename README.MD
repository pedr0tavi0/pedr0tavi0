...
![Ashutosh's github activity graph](https://contribution.catsjuice.com/_/pedr0tavi0?chart=3dbar&gap=0.6&scale=2&flatten=1&animation=wave&animation_duration=1&animation_delay=0.05&animation_amplitude=20&animation_frequency=0.5&animation_wave_center=0_0&weeks=30&theme=native&widget_size=medium&dark=true) 
